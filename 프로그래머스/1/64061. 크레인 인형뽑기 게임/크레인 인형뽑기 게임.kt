class Solution {
    fun solution(board: Array<IntArray>, moves: IntArray): Int {
        ...
        // 2. 행 0부터 ->N-1까지 0이 아닌 순간을 찾는다 => 최악 O(N) => moves의 수가 K라면  O(K*N) -> 최악의 경우 1000 × 100 = 100,000 연산.
        // 3. 열의 개수만큼 가장 상단 인덱스를 저장하는 배열을 만든다 
        //     => 메모리 좀 차지하겠지만 처음 초기화 최악 O(N^2) 이후로는 탐색 O(1) 전체 복잡도: O(N² + K) -> 최악의 경우 10,000 + 1,000 = 11,000 연산.
